                ...
                <div
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 p-8">
                        ...
                        <div className="lg:col-span-1 grid grid-cols[2fr_1fr_1fr] gap-6 mb-8">
                            <div className="relative">
                                ...
                                <div className="absolute top-4 right-4">
                                    <div
                                        className={`flex items-center gap-2 px-3 py-1 rounded-full ${getStatusColor(character.status)} text-white text-sm font-medium shadow-lg`}>
                            ...
                            {/* Origin */}
                            <div
                                className="bg-gray-50 dark:bg-gray-900 rounded-xl p-4 border-2 border-gray-200 dark:border-gray-700">
                        ...
                        <div className="lg:col-span-2">
                            ...
                            {/* Episodes Section */}
                            <div
                                className="bg-gray-50 dark:bg-gray-900 rounded-xl p-6 border-2 border-gray-200 dark:border-gray-700">
                                ...
                                {loadingEpisodes ? (
                                    <div className="flex items-center justify-center py-8">
                                        <div
                                            className="animate-spin rounded-full h-12 w-12 border-t-4 border-b-4 border-purple-500"></div>
                                    </div>
                                ) : (
