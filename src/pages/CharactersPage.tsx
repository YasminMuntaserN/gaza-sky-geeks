...
const CharactersPage: React.FC = () => {
    ...
    const {characters, totalPages, isLoading} = useCharacters(page, search);
            ...
            <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
                ...
                {isLoading ? (
                    <div className="flex items-center justify-center py-20">
                        <div
                            className="animate-spin rounded-full h-16 w-16 border-t-4 border-b-4 border-purple-500"></div>
                    </div>
                ) : (
                    <>
                        <>
                            {characters.length > 0 ? (
                                <div
                                    className="w-full grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6 mb-8">
